...
@WebServlet(name = "ControllerCoursePlayerServlet", urlPatterns = {
    "/_disabled/course-players",
    "/_disabled/my-courses/course-players"
})
public class ControllerCoursePlayerServlet extends HttpServlet {
