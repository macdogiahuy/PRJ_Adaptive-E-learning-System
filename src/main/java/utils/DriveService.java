...
public class DriveService {
        ...
        // OAuth client loaded from environment (env.properties) via EnvConfig
        // Move secrets to src/main/resources/env.properties and ensure .gitignore
        // ignores it.
        ...
        public static final String REDIRECT_URI = EnvConfig.get("GOOGLE_REDIRECT_URI",
                        "http://localhost:8080/Adaptive_Elearning/oauth2drivecallback");
        ...
        public static String uploadFile(InputStream stream, String mimeType, Credential credential)
                ...
                com.google.api.client.http.InputStreamContent content = new com.google.api.client.http.InputStreamContent(
                                mimeType, stream);

                Drive drive = getDriveService(credential);

                com.google.api.services.drive.model.File file = drive.files().create(metadata, content)
                                .setFields("id")
                                .execute();
        ...
        public static void setFilePublic(String fileId, Credential credential) throws IOException {
                ...
                try {
                        com.google.api.services.drive.model.Permission p = drive.permissions()
        ...
        public static String getOrCreateFolder(String parentId, String folderName, Credential credential)
                ...
                com.google.api.services.drive.Drive.Files.List req = drive.files().list().setQ(q)
                ...
                com.google.api.services.drive.model.File folder = drive.files().create(metadata).setFields("id")
                                .execute();
