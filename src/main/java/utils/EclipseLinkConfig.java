...
/**
 * Runtime configuration for EclipseLink JPA to bypass SSL certificate validation on local SQL Server.
 * This is ONLY for development. For production, use proper certificate validation.
 */
public class EclipseLinkConfig {
    ...
    /**
     * Get or create a configured EntityManagerFactory with SSL bypass for local dev.
     * Override the persistence.xml settings at runtime to use trustServerCertificate=true.
     */
    public static synchronized EntityManagerFactory getEntityManagerFactory() {
        if (emf == null) {
            try {
                ...
                properties.put(PersistenceUnitProperties.JDBC_PASSWORD, "123456789");
                ...
                LOGGER.log(Level.INFO, "✅ EntityManagerFactory created for SQL Server at localhost:1433 with trustServerCertificate=true");
