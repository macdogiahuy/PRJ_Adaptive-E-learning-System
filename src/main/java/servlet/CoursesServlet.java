...
public class CoursesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Ensure the fixed category keys exist so JSP badges show 0 instead of nothing
            String[] fixedCats = new String[] {"Development", "Business", "Marketing", "Design"};
            for (String fc : fixedCats) {
                if (!categoryCounts.containsKey(fc)) categoryCounts.put(fc, 0);
            }
