...
<section class="hero text-center">
    ...
    <button class="btn btn-danger btn-lg mt-3">Sign Up Now</button>
</section>
...
<section class="courses container mt-5">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <img src="assets/images/course1.jpg" class="card-img-top" alt="Java">
                <div class="card-body">
                    <h5 class="card-title">Java Programming Basics</h5>
                    <p class="card-text">Learn the fundamentals of Java programming.</p>
