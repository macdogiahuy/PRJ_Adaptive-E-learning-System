...
<body>
    ...
    <div class="container">
        ...
        <main class="main-content">
            ...
            <div class="search-section">
                <form class="search-form" method="GET" action="/adaptive_elearning/admin_notification.jsp">
    ...
    <script>
        ...
        function updateEntries() {
            ...
            const url = '/adaptive_elearning/WEB-INF/views/admin/notification.jsp?page=1&entries=' + selectedEntries + '&type=' + encodeURIComponent(selectedType);
