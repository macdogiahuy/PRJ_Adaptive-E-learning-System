...
<head>
    ...
    <title>Liên hệ - EduHub</title>
    <meta name="description" content="Liên hệ với EduHub để được hỗ trợ, giải đáp thắc mắc hoặc đóng góp ý kiến. Chúng tôi luôn sẵn sàng lắng nghe bạn!">
            ...
            <div class="contact-info">
                ...
                <div class="info-card">
                    ...
                    <div class="info-details">
                        <div class="info-detail">
                            <i class="fas fa-envelope"></i>
                            <span>support@eduhub.vn</span>
                        </div>
                        <div class="info-detail">
                            <i class="fas fa-envelope-open"></i>
                            <span>info@eduhub.vn</span>
                        </div>
                    </div>
                </div>
